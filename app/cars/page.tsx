...
//   model: string
//   year: number
//   price: { daily: number; halfDay: number; weekly?: number; monthly?: number }
//   image: string
//   type: string
//   features?: string[]
//   gallery?: string[]
...
// export default function CarsListing() {
//   return (
//     <Suspense fallback={<div className="p-8 text-center dark:text-white">Loading cars...</div>}>
//       <CarsContent />
//     </Suspense>
//   )
// }
...
//   const types = ['SUV', 'Sedan', 'Luxury', 'Sports', 'Van']  // Added Van for Hiace
//   const brands = ['Toyota', 'Nissan', 'Mercedes', 'Range Rover', 'BMW', 'Porsche']  // Added Toyota/Nissan

//   return (
//     <section className="py-16 bg-white dark:bg-gray-900">
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex justify-between items-center mb-8">
//           <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Our Cars</h1>
//           <Link href="/cars/new" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add New Car</Link>  // Optional admin link
//         </div>
...
//             value={filters.price} 
//             onChange={(e) => handleFilterChange('price', e.target.value)}
//             className="p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
//           >
//             <option value="">All Prices</option>
...
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {filteredCars.map((car) => (
//             <Link key={car.id} href={`/cars/${car.id}`} className="block">  {/* Link to detail page */}
...
//           ))}
//         </div>
//         {filteredCars.length === 0 && <p className="text-center text-gray-500 dark:text-gray-400 mt-8">No cars found. Try adjusting filters.</p>}
//       </div>
//     </section>
//   )
// }